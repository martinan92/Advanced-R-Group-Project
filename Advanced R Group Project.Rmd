...
smote_train_df <- SMOTE(y ~ ., train_to_smote, perc.over = 500, perc.under = 0)
print(summary(smote_train_df))
...
### FE1: Drop Day
The first engineered feature attempted was dropping the day column.
```{r}
...
### FE2: Drop Pdays
The second engineered feature attempted was dropping the pdays column.
```{r}
...
### FE3: Combined
The third engineered feature attempted was dropping the both days and pdays column.
```{r}
...
### FE4: Cluster
The fourth engineered feature created 4 clusters based on the age, balance, and total_contact (campaigns + previous).
```{r}
