...
clustered_validation_df <- clustering(df_train=smote_train_df, df_test=scaled_validation_df, n_clusters=4)$test

prediction<-predict(logit_cluster, clustered_validation_df)
write.csv(prediction, file = "Data/output.csv", row.names = FALSE)
